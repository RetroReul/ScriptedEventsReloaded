...
public class PlayerValue : Value, IValueWithProperties
{
    ...
    public static readonly Dictionary<PlayerProperty, IValueWithProperties.PropInfo> PropertyInfoMap = new()
    {
        ...
        [PlayerProperty.PosX] = new Info<NumberValue>(plr => (decimal)plr.Position.x, null),
        [PlayerProperty.PosY] = new Info<NumberValue>(plr => (decimal)plr.Position.y, null),
        [PlayerProperty.PosZ] = new Info<NumberValue>(plr => (decimal)plr.Position.z, null),
